...
public class Custom_Data_Base_Creation_Jdialog extends JDialog {
	...
	public interface Custom_Jdialog_Data_Base {
	 ...
	 * Create the dialog.
	 */
	public Custom_Data_Base_Creation_Jdialog(Custom_Jdialog_Data_Base This_Jdialog_Data_Base, String Name) {
		setResizable(false);
		...
		contentPanel.setLayout(null);
		{
			...
			}
			{
				...
				Icon Toggle_View_Icon = new ImageIcon(Custom_Data_Base_Creation_Jdialog.class.getResource("/Icons/eye-3x.png"));
	...
	private void Construct(Custom_Jdialog_Data_Base This_Jdialog_Data_Base) {
