...
public class PassWord_Data_Base_Creation_Jdialog extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public PassWord_Data_Base_Creation_Jdialog(Node_Container Container, String Name) {
	...
	private void Construct(Node_Container Container) {
		...
		if (Digi.length >= Min_Numbers && Symb.length >= Min_Symboles && Alpha.length >= Min_Letters
			...
			Container.setMain_PassWord(Value);
