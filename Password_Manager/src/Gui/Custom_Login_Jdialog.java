...
public class Custom_Login_Jdialog extends JDialog {
	...
	public interface Custom_Jdialog_Login {
	 ...
	 * Create the dialog.
	 */
	public Custom_Login_Jdialog(Custom_Jdialog_Login This_Jdialog_Login, String A_Name) {
		setTitle("Login");
		setResizable(false);
